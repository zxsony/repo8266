...
void sampleWrite() {
  sampleDataStack [sampleCount][0] = am2320t;
  sampleDataStack [sampleCount][1] = am2320h;
  ...
  sampleDateTimeStack [sampleCount][4] = year - 100;

...
//  }
  ...
  serverIndex += "</td><td>";
  if (tempStack [0][4] > 0){serverIndex += tempStack [0][4] - tempStack [23][4];}
    else {serverIndex += 0;}
  serverIndex += "</td><td>";
  if (tempStack [0][5] > 0){serverIndex += tempStack [0][5] - tempStack [23][5];}
  else {serverIndex += 0;}
  ...
  for (int i = 1; i<24; i++){
    ...
    serverIndex += "</td><td>";
    if (tempStack [i][4] > 0){serverIndex += tempStack [i][4] - tempStack [i-1][4];}
      else {serverIndex += 0;}
    serverIndex += "</td><td>";
    if (tempStack [i][5] > 0){serverIndex += tempStack [i][5] - tempStack [i-1][5];}
      else {serverIndex += 0;}
    //Serial.println(AM2320Stack[i][1]);
  }
